...
import { Button, ErrorMessage, FieldGroup, Form, Label, SettingsInput } from '@styles/styled-components'
		...
		<Container>
			<ModifiedForm onSubmit={handleSubmit(onSubmit)}>
				<ModifiedFieldGroup>
					...
					<SettingsInput type="text" name="displayName" ref={register} hasError={errors.displayName} disabled />
				</ModifiedFieldGroup>
				<ModifiedFieldGroup>
