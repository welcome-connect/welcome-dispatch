...
import { Button, Form, FieldGroup, ErrorMessage, SettingsInput, Label } from '@styles/styled-components'
				...
				{!leadExists.exists ? (
					<>
						<ModifiedFieldGroup>
							...
							<SettingsInput type="text" name="displayName" ref={register} hasError={errors.displayName} />
						</ModifiedFieldGroup>
						<ModifiedFieldGroup>
